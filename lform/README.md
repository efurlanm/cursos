...
Estudo de linguagens artificias com aplicações em modelagem biológica, inteligência artificial, integração com sistemas de empresas, loja virtual e atendimento ao cliente (chatbot), assistentes pessoais virtuais, IoT, e compiladores, entre outras.
